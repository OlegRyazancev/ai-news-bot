...
Исправлена misleading targeted CLI-диагностика после реального `TIMEOUT` статьи №15 и исчерпания дневного бюджета 5/5; новые unit/PostgreSQL regression tests проходят локально и в GitHub Actions.
